...
inline bool business_condition(const nlohmann::json &summary, const nlohmann::json &parameters) {
    static const std::set<std::string> fields{
        ...
        "/sandman/phase", "/sandman/active", "/sandman/unit_matches", "/sandman/leap_pending", "/sandman/bondmate_confirmed",
        ...
        "/repel_forces/phase", "/repel_forces/active", "/repel_forces/unit_matches", "/repel_forces/pending", "/repel_forces/battles_in_pair",
        "/fordraig/active", "/fordraig/phase", "/fordraig/pending", "/fordraig/unit_matches",
        "/cave_of_separation/phase", "/cave_of_separation/active", "/cave_of_separation/pending",
        "/cave_of_separation/request_seen", "/cave_of_separation/unit_matches", "/cave_of_separation/segment_complete",
        "/fishing/reward_pending",
        "/fishing/waiting", "/fishing/timed_out",
        "/fishing/casting_pending",
        "/fishing/refill_phase", "/fishing/transfer_inputs_confirmed", "/fishing/transfer_pending",
