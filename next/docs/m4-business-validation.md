...
| M4.7 专项任务 | 15 个 quest 的原始数据保留；要塞八层陷阱原生有限迭代与七个因果场景已接线，构建/状态 19 方法通过 | 自动移动场景识别超过 TTL 的依赖待解，要塞流程未验；其它 14 项专项未实现，见 m4-fortress-trap-validation.md；完整专项验收均未放行 |
