...
| M4.7 专项任务 | 15个quest原始数据保留；陷阱历史7场景通过；巨人/暗灯有限链阻断；挖矿矿点循环、冷启动、去重、十八输入实际住宿补镐子八场景通过，另全矿物/mod/ROI与错点负例通过 | 巨人/暗灯不再重跑；挖矿完整入本后的寻路确认待修；其它11专项实际链未完成，时间跳跃共用组件正在接线；完整任务验收仍未放行 |
