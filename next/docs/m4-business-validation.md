...
| M4.7 专项任务 | 15个quest原始数据保留；陷阱七点历史流程7场景通过；巨人新增入本/两点/回城/间隔住宿有限图，状态回执通过，流程待验 | 后续共用改动的同产物回归未齐；巨人流程验证及其它13专项实际链未完成，源码语义见 migration/m4-special-task-contracts.md；完整任务验收仍未放行 |
