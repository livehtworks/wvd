...
| M4.7 专项任务 | 15个quest原始数据保留；陷阱历史7场景通过；巨人/暗灯/半自动大恶魔阻断；挖矿入口、连续周期和Pause恢复分项通过；无因果跳跃及悬赏菜单通过；住宿40次单批通过；蝎女链分项验证中、钓鱼子链待验 | 三专项不再重跑；挖矿未知后置；住宿跨批/恢复；蝎女六手矩阵及其余七专项完整链未完成，完整任务验收仍未放行 |
