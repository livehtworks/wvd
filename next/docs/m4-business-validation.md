...
| M4.7 专项任务 | 15个quest原始数据保留；陷阱七点历史流程7场景通过；巨人和暗灯有限图及状态已接入，实际完整流程均受场景确认阻断 | 两专项已达有限修正边界，不再重跑挑PASS；其它12专项实际链未完成，源码语义见 migration/m4-special-task-contracts.md；完整任务验收仍未放行 |
