...
| M4.7 专项任务 | 15个quest原始数据保留；要塞八层陷阱七点有限迭代，状态19方法及流程5方法/7场景通过，含33/49/66次完整输入链 | 后续共用改动的同产物回归未齐；其它14专项实际链未实现，源码语义见 migration/m4-special-task-contracts.md；完整任务验收仍未放行 |
