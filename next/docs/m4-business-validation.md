...
| M4.7 专项任务 | 15个quest原始数据保留；陷阱历史7场景通过；巨人/暗灯/半自动大恶魔阻断；挖矿入口、连续周期和Pause恢复分项通过；无因果时间跳跃八场景通过；悬赏菜单七场景通过；连续住宿250段已接线待验 | 三专项不再重跑；挖矿未知后置；连续住宿回归；其它九专项实际链未完成，完整任务验收仍未放行 |
