...
class PlanTests(unittest.TestCase):
    ...
    def test_implemented_specials_bind_real_manifest_without_hiding_remaining(self):
        ...
        self.assertEqual(set(implemented), {"fortress-B8F_trap", "7000G", "LBC-oneGorgon", "gaintKiller", "darkLight", "FFXI-Org", "manualSepDemon", "lovesleep", "Scorpionesses", "Scorpionesses_plus_6_hands", "fishing", "fishing2", "jier", "SSC-goldenchest", "sandman"})
        ...
        self.assertEqual(implemented["jier"]["required_normal_units"], 3)
        ...
        for row in featured:
            ...
            self.assertEqual(row["scope"], "FEATURED_VISIT_ONLY_NOT_FULL_TASK")
